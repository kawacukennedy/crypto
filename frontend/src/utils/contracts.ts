...
// CryptoGames contract ABI
export const CRYPTO_GAMES_ABI = [
  {
    "inputs": [
      {
        "internalType": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": true,
        "internalType": "enum CryptoGames.GameType",
        "name": "gameType",
        "type": "uint8"
      },
      {
...
export const getGamesContractAddress = (chainId: number): string => {
  return GAMES_CONTRACT_ADDRESSES[chainId] || '';
};
